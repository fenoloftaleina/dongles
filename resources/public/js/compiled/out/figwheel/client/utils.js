...
return (new CustomEvent(event_name,(function (){var obj27853 = ({"detail":data});
return obj27853;
})()));
} else {
...
var f = (function (){var pred__27860 = cljs.core._EQ_;
var expr__27861 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27860.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27861))){
return ((function (pred__27860,expr__27861){
return (function (p1__27854_SHARP_){
return console.warn(p1__27854_SHARP_);
});
;})(pred__27860,expr__27861))
} else {
if(cljs.core.truth_(pred__27860.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27861))){
return ((function (pred__27860,expr__27861){
...
if(cljs.core.truth_(pred__27860.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27861))){
return ((function (pred__27860,expr__27861){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27864){
...
var opts = map__27865__$1;
var eval_fn = cljs.core.get.call(null,map__27865__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27867_SHARP_);
});})(new_def))
);
...
return (function (p__27868){
var vec__27869 = p__27868;
var ky = cljs.core.nth.call(null,vec__27869,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1562604885748
