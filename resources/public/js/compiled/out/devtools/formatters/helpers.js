...
var G__22095 = devtools.prefs.pref.call(null,v);
v = G__22095;
continue;
} else {
return v;
...
}catch (e22098){var _e__21838__auto__ = e22098;
return false;
}})();
...
}catch (e22102){var _e__21838__auto__ = e22102;
return false;
}})();
...
}catch (e22104){var _e__21838__auto__ = e22104;
return false;
}}
}
});
...
var vec__22106 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22106,(0),null);
var name = cljs.core.nth.call(null,vec__22106,(1),null);
...
return cljs.core.some.call(null,(function (p1__22109_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22109_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1562604879745
