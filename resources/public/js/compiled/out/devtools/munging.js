...
var temp__5718__auto____$1 = (o21990["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21991 = temp__5718__auto____$1;
return (o21991["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21831__auto__ = f;
return (o__21831__auto__["toString"]).call(o__21831__auto__);
} else {
return "";
}
}catch (e21992){var _ = e21992;
return "";
}});
...
try{var o__21831__auto___21994 = t;
(o__21831__auto___21994["cljs$lang$ctorPrWriter"]).call(o__21831__auto___21994,t,writer);
}catch (e21993){var __21995 = e21993;
}
...
var char_code = (function (){var o__21831__auto__ = (new String(char$));
return (o__21831__auto__["charCodeAt"]).call(o__21831__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21831__auto__ = String;
return (o__21831__auto__["fromCharCode"]).call(o__21831__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21996 = num_code;
switch (G__21996) {
case (1):
return (185);
...
var o__21831__auto__ = String;
return (o__21831__auto__["fromCharCode"]).call(o__21831__auto__,superscript_code);
});
/**
...
}catch (e21998){var _e__21838__auto__ = e21998;
return false;
}})())){
...
var vec__21999 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21999,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22002 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22002["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22003 = temp__5718__auto____$1;
return (o22003["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22006){
var vec__22007 = p__22006;
var ns_detector = cljs.core.nth.call(null,vec__22007,(0),null);
...
var G__22013 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22014 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22013;
remaining_tokens = G__22014;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22004){
var G__22005 = cljs.core.first.call(null,seq22004);
var seq22004__$1 = cljs.core.next.call(null,seq22004);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22005,seq22004__$1);
});
...
var vec__22018 = cljs.core.split_with.call(null,(function (p1__22017_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22017_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22018,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22018,(1),null);
...
var vec__22024 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22024,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22024,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22027 = cljs.core.rest.call(null,remaining_tokens);
var G__22028 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22027;
name_tokens = G__22028;
continue;
} else {
...
var vec__22031 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22031,(0),null);
var arity = cljs.core.nth.call(null,vec__22031,(1),null);
var vec__22034 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22034,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22034,(1),null);
var vec__22037 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22037,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22037,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22037,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22037,(3),null);
...
var vec__22043 = result;
var munged_ns = cljs.core.nth.call(null,vec__22043,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22043,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22043,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22043,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22043,(4),null);
var arity = cljs.core.nth.call(null,vec__22043,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22047 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22047,(0),null);
var args = cljs.core.nth.call(null,vec__22047,(1),null);
var vec__22050 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22050,(0),null);
var name = cljs.core.nth.call(null,vec__22050,(1),null);
...
var G__22053 = (arity + (1));
var G__22054 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22055){
var vec__22056 = p__22055;
var arity = cljs.core.nth.call(null,vec__22056,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22056,(1),null);
...
return cljs.core.get.call(null,arities,p1__22059_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22060_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___22067 = arguments.length;
var i__4731__auto___22068 = (0);
while(true){
if((i__4731__auto___22068 < len__4730__auto___22067)){
args__4736__auto__.push((arguments[i__4731__auto___22068]));

var G__22069 = (i__4731__auto___22068 + (1));
i__4731__auto___22068 = G__22069;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22063){
var vec__22064 = p__22063;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22064,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22061){
var G__22062 = cljs.core.first.call(null,seq22061);
var seq22061__$1 = cljs.core.next.call(null,seq22061);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22062,seq22061__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22072__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22072__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22072__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22072__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22073 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22073,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22073,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22073,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22073,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22073,(4),null);
var arity = cljs.core.nth.call(null,vec__22073,(5),null);
...
var o__21831__auto__ = f;
return (o__21831__auto__["getBasis"]).call(o__21831__auto__);
});
/**
...
}catch (e22077){var _e__21838__auto__ = e22077;
...
var G__22078 = (obj[cljs.core.first.call(null,path)]);
var G__22079 = cljs.core.rest.call(null,path);
obj = G__22078;
path = G__22079;
continue;
} else {
...
return (function (accum,p__22080){
var vec__22081 = p__22080;
var bit = cljs.core.nth.call(null,vec__22081,(0),null);
var protocol = cljs.core.nth.call(null,vec__22081,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22084){
var vec__22085 = p__22084;
var ns = cljs.core.nth.call(null,vec__22085,(0),null);
var name = cljs.core.nth.call(null,vec__22085,(1),null);
var selector = cljs.core.nth.call(null,vec__22085,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22090,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22090,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22090,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22088_SHARP_){
return (obj[cljs.core.first.call(null,p1__22088_SHARP_)]);
});})(name,sorted_matches,vec__22090,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1562604879659
