...
var G__24216 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24216;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24217 = rdr;
...
if(("\\" === ch__$1)){
var ch_24218__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24218__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24218__$2);
} else {
}

var G__24219 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24219;
continue;
}
}
...
var vec__24227 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24227,(0),null);
var start_column = cljs.core.nth.call(null,vec__24227,(1),null);
...
var G__24230 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24230;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24231 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24232 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24232;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24231;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24233 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24233,(0),null);
var start_column = cljs.core.nth.call(null,vec__24233,(1),null);
...
var vec__24236 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24236,(0),null);
var end_column = cljs.core.nth.call(null,vec__24236,(1),null);
...
var vec__24239 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24239,(0),null);
var start_column = cljs.core.nth.call(null,vec__24239,(1),null);
...
var vec__24242 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24242,(0),null);
var end_column = cljs.core.nth.call(null,vec__24242,(1),null);
...
var vec__24245 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24245,(0),null);
var start_column = cljs.core.nth.call(null,vec__24245,(1),null);
...
var vec__24248 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24248,(0),null);
var end_column = cljs.core.nth.call(null,vec__24248,(1),null);
...
var sb = (function (){var G__24251 = (new goog.string.StringBuffer());
G__24251.append(initch);
...
var G__24253 = (function (){var G__24252 = sb;
G__24252.append(ch);

return G__24252;
})();
var G__24254 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24253;
ch = G__24254;
continue;
}
...
switch (G__24257) {
case "\\":
var G__24261 = (function (){var G__24258 = sb;
G__24258.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24258;
})();
var G__24262 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24261;
ch = G__24262;
continue;
...
break;
default:
var G__24263 = (function (){var G__24259 = sb;
G__24259.append(ch);

return G__24259;
})();
var G__24264 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24263;
ch = G__24264;
continue;
...
var vec__24265 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24265,(0),null);
var end_column = cljs.core.nth.call(null,vec__24265,(1),null);
...
var vec__24268 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24268,(0),null);
var column = cljs.core.nth.call(null,vec__24268,(1),null);
...
var vec__24273 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24273,(0),null);
var column = cljs.core.nth.call(null,vec__24273,(1),null);
...
var vec__24278 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24278,(0),null);
var column = cljs.core.nth.call(null,vec__24278,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24283 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24283,(0),null);
var start_column = cljs.core.nth.call(null,vec__24283,(1),null);
...
var vec__24286 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24286,(0),null);
var end_column = cljs.core.nth.call(null,vec__24286,(1),null);
...
var G__24289 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24289,true,null,opts,pending_forms);
...
var G__24290 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24290)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24290)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24290)){
...
var _STAR_suppress_read_STAR__orig_val__24291 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24292 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24292;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24291;
}});
...
var G__24293 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24293,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24293,rdr,first_line);
...
var G__24297 = matched;
var G__24298 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24297;
finished = G__24298;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24299 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24300 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24300;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24299;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24301 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24302 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__24302;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24303 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24303,"(");
...
var G__24304 = (i + (1));
var G__24305 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__24301;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24306 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24306);
...
var G__24307 = cljs.core.next.call(null,s__$1);
var G__24308 = ret;
s__$1 = G__24307;
r = G__24308;
continue;
...
var G__24310 = cljs.core.next.call(null,s);
var G__24311 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24310;
key_vals = G__24311;
continue;
} else {
...
var gensym_env_orig_val__24315 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24316 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__24316;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__24315;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24317 = token;
var G__24317__$1 = (((G__24317 == null))?null:cljs.core.subs.call(null,G__24317,(1)));
var G__24317__$2 = (((G__24317__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24317__$1));
var G__24317__$3 = (((G__24317__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24317__$2));
var G__24317__$4 = (((G__24317__$3 == null))?null:cljs.core.symbol.call(null,G__24317__$3));
if((G__24317__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24317__$4);
}
})():(function (){var G__24318 = token;
var G__24318__$1 = (((G__24318 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24318));
if((G__24318__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24318__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24329,reader){
var map__24330 = p__24329;
var map__24330__$1 = (((((!((map__24330 == null))))?(((((map__24330.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24330.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24330):map__24330);
var opts = map__24330__$1;
var eof = cljs.core.get.call(null,map__24330__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___24338 = arguments.length;
var i__4731__auto___24339 = (0);
while(true){
if((i__4731__auto___24339 < len__4730__auto___24338)){
args__4736__auto__.push((arguments[i__4731__auto___24339]));

var G__24340 = (i__4731__auto___24339 + (1));
i__4731__auto___24339 = G__24340;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24336){
var G__24337 = cljs.core.first.call(null,seq24336);
var seq24336__$1 = cljs.core.next.call(null,seq24336);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24337,seq24336__$1);
});


//# sourceMappingURL=reader.js.map?rel=1562604883170
